  ...
  const certificatesData = [
    {
      ...
      date: "September 2024",
      link: "https://media.geeksforgeeks.org/courses/certificates/a80f887554aaf0f3aada78e7d4e85227.pdf",
    ...
    },
    {
      ...
      issuer: "Coursera",
      date: "March 2024",
      link: "https://www.coursera.org/account/accomplishments/verify/GGX784SQ8VJ9",
      icon: <Award className="h-6 w-6 text-emerald-600 dark:text-emerald-500" />,
    },
    {
      ...
      issuer: "Coursera",
      date: "May 2024",
      link: "https://www.coursera.org/account/accomplishments/verify/DXXEFBAE47L3",
      icon: <Award className="h-6 w-6 text-emerald-600 dark:text-emerald-500" />,
    },
  ]
